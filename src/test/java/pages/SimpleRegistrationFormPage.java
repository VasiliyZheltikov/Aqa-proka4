...
@Log4j2
public class SimpleRegistrationFormPage extends BasePage {
    ...
    public SimpleRegistrationFormPage open() {
    ...
    public SimpleRegistrationFormPage isPageOpened() {
        try {
    ...
    public SimpleRegistrationFormPage fillRegistrationForm(
        String username,
        String email,
        String password,
        String country,
